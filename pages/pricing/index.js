        ...
        <section style={{ background: `linear-gradient(120deg, rgba(2,0,36,1) 0%, rgba(29,0,15,1) 100%)` }} className="min-h-[100vh] text-gray-400 body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto mt-20">
                <div className="flex flex-col text-center w-full mb-20">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Choose a plan for better perks and features.</p>
                </div>
                <div className="flex flex-wrap -m-4">
                    <div className="p-4 xl:w-1/4 lg:w-1/2 w-full">
                        <div className="bg-velvet h-full p-6 rounded-lg border-2 border-velvet flex flex-col relative overflow-hidden">
                            ...
                            <Link href="/models/rewrite" className='mt-auto'>
                                <button className="flex items-center mt-auto text-white bg-gray-800 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-700 rounded">Try
...
export async function getServerSideProps({ req, res }) {
    ...
    const UNSIGNED_PROPS = { props: { 
        basic: "/auth/signup?redirect=/api/intent/basic", 
        pro: "/auth/signup?redirect=/api/intent/pro",
        expert: "/auth/signup?redirect=/api/intent/expoert",
        session: false 
    }};
    ...
    if (['basic', 'pro', 'expert'].includes(query?.subscription)) {
        ...
        return { redirect: { destination: "/pricing/upgrade" }};
    }
